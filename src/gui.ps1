...
if ($hostInput -eq "0") {
    ...
    if ($installed) {
        ...
        irm "https://raw.githubusercontent.com/bCelery/bCelery.github.io/main/src/modules/install.ps1" | iex
    }
} elseif ($hostInput -eq "2") {
    if ($installed) {
        irm "https://raw.githubusercontent.com/bCelery/bCelery.github.io/main/src/modules/repair.ps1" | iex
    } else {
        Clear-Host
    ...
    if ($installed) {
        irm "https://raw.githubusercontent.com/bCelery/bCelery.github.io/main/src/modules/uninstall.ps1" | iex
    } else {
        Clear-Host
        betterPause -Message "Error: Celery is not installed, did you mean to install it?"
    }
    ...
    if (($versiondata[0] -ne $newestversion) -and $installed) {
        irm "https://raw.githubusercontent.com/bCelery/bCelery.github.io/main/src/modules/advrepair.ps1" | iex
    } else {
        Clear-Host
